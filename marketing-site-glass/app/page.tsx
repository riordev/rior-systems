      ...
      <section className="relative px-6 py-24 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="flex flex-wrap gap-4">
            <a 
              href="#pricing" 
              className="px-8 py-4 bg-white/10 backdrop-blur-xl border border-white/20 rounded-xl font-medium hover:bg-white/20 transition"
            >
              Get started
            </a>
            <a 
              href="/builds" 
              className="px-8 py-4 backdrop-blur-xl border border-white/20 rounded-xl font-medium hover:bg-white/10 transition"
            >
              See how we build
            </a>
          </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={item.title} className="p-6 backdrop-blur-xl bg-white/5 rounded-2xl border border-white/10">
