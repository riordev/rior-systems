    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      ...
      <section className="relative px-6 pt-32 pb-24 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto">
          <div className="backdrop-blur-xl bg-slate-800/50 rounded-2xl border border-white/10 p-4 inline-flex items-center gap-3 mb-8">
            ...
            <span className="text-slate-300 text-sm">Now accepting clients</span>
          </div>
          ...
          <div className="flex flex-wrap gap-4">
            <a 
              href="#pricing" 
              className="px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-500 rounded-xl font-medium hover:from-blue-400 hover:to-purple-400 transition"
            >
              Get started
            </a>
            <a 
              href="/builds" 
              className="px-8 py-4 backdrop-blur-xl bg-slate-800/50 border border-white/20 rounded-xl font-medium hover:bg-slate-700/50 transition"
            >
              See how we build
            </a>
          </div>
      ...
      <section className="px-6 py-20">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold mb-12 text-white">The problem</h2>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { icon: "×", title: "Can't see true profit", desc: "Shopify revenue minus ad spend doesn't equal profit. You're missing COGS, shipping, and processing fees." },
              { icon: "×", title: "Don't know break-even", desc: "Every SKU has a different break-even ROAS. Most founders guess. We calculate it precisely." },
              { icon: "×", title: "Scaling blind", desc: "You're making scaling decisions without knowing which products are actually profitable." }
            ].map((item) => (
              <div key={item.title} className="p-6 backdrop-blur-xl bg-slate-800/50 rounded-2xl border border-white/10">
                <div className="text-red-400 text-2xl mb-4">{item.icon}</div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              ...
              <div key={step.num} className="flex gap-6 p-6 backdrop-blur-xl bg-slate-800/50 rounded-2xl border border-white/10">
                <div className="text-3xl font-bold text-slate-600">{step.num}</div>
                <div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-8 backdrop-blur-xl bg-gradient-to-br from-blue-500/10 to-purple-500/10 rounded-2xl border border-white/10">
              <div className="text-slate-400 text-sm mb-2">Setup</div>
              <div className="text-4xl font-bold mb-4 text-white">$2,500-$4,000</div>
              <p className="text-slate-400 mb-6">One-time fee. Includes full dashboard build, data pipeline, and team training.</p>
            ...
            <div className="p-8 backdrop-blur-xl bg-slate-800/50 rounded-2xl border border-white/10">
              ...
              <div className="text-4xl font-bold mb-4 text-white">$1,500-$3,000</div>
              <p className="text-slate-400 mb-6">Ongoing monitoring, maintenance, and optimization. Cancel anytime with 30 days notice.</p>
              <ul className="space-y-3 text-sm">
